...
import { CalendarIcon, DoorIcon, TimeIcon } from "../../components/icons/Icons";
...
export const AttendanceCard = ({ attendance, onClick }) => {
        ...
        <Row className="align-items-center">
          <Col md="3">
            <div className="text-muted small">
              <CalendarIcon size="16px" color="gray" /> Дата
            </div>
          ...
          <Col md="2">
            <div className="text-muted small">
              <TimeIcon size="16px" color="gray" /> Время
            </div>
            <div className="fw-bold">
          ...
          <Col md="2">
            <div className="text-muted small">
              <DoorIcon size="16px" color="gray" /> Комната
            </div>
